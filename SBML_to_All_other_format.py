...
path_to_models = '/home/rmiraska/Downloads/BIOMODELS/'
models = ['e_coli_core', 'BIOMD0000000001', 'BIOMD0000000002', 'BIOMD0000000003', 'BIOMD0000000004', 'BIOMD0000000005', 'BIOMD000000034', 'BIOMD0000000610', 'BIOMD0000000674'];
models = ['BIOMD000000000'+str(i) for i in range(1, 10)]+['BIOMD00000000'+str(i) for i in range(10, 100)]+['BIOMD0000000'+str(i) for i in range(100, 707)]
models = ['e_coli_core', 'iAB_RBC_283', 'iAF692', 'iAF987', 'iAT_PLT_636', 'iHN637', 'iIT341', 'iJB785', 'iJN678', 'iJN746', 'iJR904', 'iLJ478', 'iMM904', 'iND750', 'iNF517', 'iNJ661', 'iPC815', 'iSB619', 'iYO844']
table = open(path_to_models+'info.csv','a')
table.write('Model, Reactions, Metabolites, Reactions after reduction, Metabolites after reduction\n')
...
def sbml_to_txt(model_name):
    ...
    table.write(model + ', ' + str(len(full_matrix[0])) + ', ' + str(len(full_matrix)))
    ...
    table.write(', ' + str(len(reduced_matrix[0])) + ', ' + str(len(reduced_matrix))+'\n')
...
for model in models:
    try:
        ...
        os.popen('mv '+path_to_models+model+' '+path_to_models+'/BIN/'+model)
